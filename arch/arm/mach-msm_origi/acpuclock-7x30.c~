...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	{ 0, 24576,  LPXO, 0, 0,  30720000,  700, VDD_RAW(700) },
	{ 0, 61440,  PLL_3,    5, 11, 61440000,  700, VDD_RAW(700) },
	...
	{ 0, 600000,  PLL_2,    3, 0,    122800000, 900,  VDD_RAW(900),  &pll2_tbl[1]},
	...
	{ 1, 1516800, PLL_2, 3, 0, UINT_MAX, 1200, VDD_RAW(1200), &pll2_tbl[6]},
	{ 1, 1612800, PLL_2, 3, 0, UINT_MAX, 1250, VDD_RAW(1250), &pll2_tbl[7]},
	{ 1, 1708800, PLL_2, 3, 0, UINT_MAX, 1300, VDD_RAW(1300), &pll2_tbl[8]},
	{ 1, 1824000, PLL_2, 3, 0, UINT_MAX, 1300, VDD_RAW(1300), &pll2_tbl[9]},
	{ 1, 1958400, PLL_2, 3, 0, UINT_MAX, 1350, VDD_RAW(1350), &pll2_tbl[10]},
	{ 0 }
};
